...
if (isset($_POST['checkProfile'])){
    ...
    // $mainImage1Name = time(). ' ' .$_FILES['mainImage1']['name'];
    // $target = 'uploads/' . $mainImage1Name;
    // if(move_uploaded_file($_FILES['mainImage1']['tmp_name'], $target)){
    //     echo "Success!";
    //     $sql = "INSERT INTO ImageCheck (mainImage1) VALUES ('$mainImage1Name')";
