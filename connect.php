    ...
    if ($user) {
        ...
        if ($pwd1 == $cpwd) {
            ...
            if (mysqli_query($conn, $sql)) {
                ...
                $_SESSION['type'] = $type;
                $loginSql = "INSERT INTO Logins (email) VALUES ('$email')";
                $loginChecker = mysqli_query($conn, $loginSql);
...
if (isset($_POST['Comment'])) {
    ...
    $hotelName = $_SESSION['hotelName'];
    $query = "INSERT INTO Comments (text, firstName, lastName, hotelName) VALUES ('$comment', '$firstName', '$lastName', '$hotelName')";
