   ...
   <div class="bar"></div>
    ...
    <div class="container-hotel">
       <form action="connect.php" method="POST" enctype="multipart/form-data" onsubmit="return checkCheckBoxes(this);">
        ...
        <br>
        <h2>Facilities</h2>
        <input type="checkbox" id="cs" name="cityView" value="cityView">
        <label for="cs"> City View</label><br>
        <input type="checkbox" id="cs" name="oceanView" value="oceanView">
        <label for="cs"> Ocean View</label><br>
        <input type="checkbox" id="cs" name="lakeView" value="lakeView">
        <label for="cs"> Lake View</label><br>
        <input type="checkbox" id="cs" name="gardenView" value="gardenView">
        <label for="cs"> Garden View</label><br>
        <input type="checkbox" id="cs" name="swimmingPool" value="swimmingPool">
        <label for="cs"> Swimming Pool</label><br>
        <input type="checkbox" id="cs" name="freeWiFi" value="freeWiFi">
        <label for="cs"> Free WiFi</label><br>
        <input type="checkbox" id="cs" name="gym" value="gym">
        <label for="cs"> Gym</label><br>
        <input type="checkbox" id="cs" name="airportShuttle" value="airportShuttle">
        <label for="cs"> Airport Shuttle</label><br>
        <input type="checkbox" id="cs" name="nonSmokingRooms" value="nonSmokingRooms">
        <label for="cs"> Non-Smoking Rooms</label><br>
        <input type="checkbox" id="cs" name="roomService" value="roomService">
        <label for="cs"> Room Service</label><br>
        <input type="checkbox" id="cs" name="differentlyAbled" value="differentlyAbled">
        <label for="cs"> Differently-Abled Friendly</label><br>
        <input type="checkbox" id="cs" name="teaCoffee" value="teaCoffee">
        <label for="cs"> Tea/Coffee-Maker in all Rooms</label><br>
        <input type="checkbox" id="cs" name="bar" value="bar">
        <label for="cs"> Bar</label><br>
        <input type="checkbox" id="cs" name="freeParking" value="freeParking">
        <label for="cs"> Free Parking</label>
        <br>
        <h2>Covid Safety</h2>
        ...
        <div class="input box">
            <?php 
                if ($updateProfile!=true) {
                    ...
                    echo '<input type="submit" value="Update and Check Profile" name="updateProfile" id="checkProfile">';
                }
            ?>
            </div>
        <br>
